...
export class CoralTabs {
  ...
  showTab(index) {
    // Удаление активного класса у всех табов и панелей
    this.tabs.forEach(tab => tab.classList.remove(this.activeClass));
    this.panes.forEach(pane => pane.classList.remove(this.activeClass));

    // Добавление активного класса к выбранному табу и панели
